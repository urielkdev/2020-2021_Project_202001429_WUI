<div class="row">
	<h3>O <?php echo$this->element('nomeApp'); ?></h3><br/>
</div>
<div class="row">
	<!--small-->
...
<div class="row">
	<div class="column">
		<div class="message default text-center">
			O <?php echo$this->element('nomeApp'); ?> é um sistema experimental e ainda em desenvolvimento. Sempre verifique os dados fornecidos em outras plataformas antes de aceitar qualquer dado fornecido como verdadeiro. <br/>
