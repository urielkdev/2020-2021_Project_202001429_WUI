...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Administrador Fundo'), ['action' => 'edit', $administradorFundo->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Administrador Fundo'), ['action' => 'delete', $administradorFundo->id], ['confirm' => __('Are you sure you want to delete # {0}?', $administradorFundo->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Administrador Fundos'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Administrador Fundo'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="administradorFundos view content">
            <h3><?= h($administradorFundo->id) ?></h3>
            <table>
                <tr>
                    <th><?= __('Cnpj') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($administradorFundo->cadastro_fundos)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($administradorFundo->cadastro_fundos as $cadastroFundos) : ?>
                        <tr>
