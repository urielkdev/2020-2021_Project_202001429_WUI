...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $indicadoresCarteira->carteiras_investimento_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $indicadoresCarteira->carteiras_investimento_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="indicadoresCarteiras form content">
            ...
            <fieldset>
                <legend><?= __('Edit Indicadores Carteira') ?></legend>
                <?php
